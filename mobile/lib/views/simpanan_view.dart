...
class _SimpananViewState extends State<SimpananView> {
  ...
  Future<void> _depositSavings(KoperasiProvider provider) async {
    ...
    final res = await provider.depositSavingsFromWallet(
        amt, 'Simpanan Sukarela Mandiri');
    setState(() {
      _isLoading = false;
    });
  ...
  Widget build(BuildContext context) {
    ...
    final int totalSimpanan = provider.simpananPokok +
    ...
    for (var s in provider.listSavings) {
      combinedTxs.add({
        ...
        'rawDate':
            DateTime.tryParse(s['transactionDate'] ?? s['createdAt'] ?? '') ??
                DateTime.now(),
      });
    }
    for (var d in provider.listDues) {
      if (d['status'] == 'paid') {
        combinedTxs.add({
          ...
          'rawDate':
              DateTime.tryParse(d['paymentDate'] ?? d['createdAt'] ?? '') ??
                  DateTime.now(),
        });
      }
    }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Simpanan & Mutasi',
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Card(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  const Text('TOTAL SIMPANAN ANDA',
                                      style: TextStyle(
                                          color: Colors.grey,
                                          fontSize: 10,
                                          fontWeight: FontWeight.bold,
                          ...
                          const Text('Rincian Simpanan Koperasi',
                              style: TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.bold,
                          ...
                          _buildSavingsCard(
                            ...
                            badgeColor: provider.isPokokPaid
                                ? Colors.green
                                : Colors.red,
                            badgeText:
                                provider.isPokokPaid ? 'LUNAS' : 'WAJIB BAYAR',
                          ),
                          ...
                          _buildSavingsCard(
                            ...
                            badgeColor: provider.isWajibPaidThisMonth
                                ? Colors.green
                                : Colors.red,
                            badgeText: provider.isWajibPaidThisMonth
                                ? 'LUNAS BULAN INI'
                                : 'TUNGGAKAN BULAN INI',
                          ),
                                  ...
                                  Expanded(
                                    child: Column(
                                      crossAxisAlignment:
                                          CrossAxisAlignment.start,
                                      children: [
                                        const Text('Simpanan Sukarela',
                                            style: TextStyle(
                                                fontSize: 14,
                                                fontWeight: FontWeight.bold,
                                                color: Color(0xFF1E293B))),
                                        const SizedBox(height: 4),
                                        const Text('Bebas menabung kapan saja.',
                                            style: TextStyle(
                                                fontSize: 10,
                                                color: Colors.grey)),
                                        const SizedBox(height: 8),
                                        Text(
                                            fmtMoney(provider.simpananSukarela),
                                            style: const TextStyle(
                                                fontSize: 16,
                                                fontWeight: FontWeight.w900,
                                                color: Color(0xFF0F172A))),
                          ...
                          const Text('Mutasi Transaksi & Riwayat',
                              style: TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.bold,
                                  color: Color(0xFF475569))),
              ...
              children: [
                ...
                if (!isPaid)
                  ElevatedButton(
                    ...
                    child: Text('Bayar ${fmtMoney(requiredAmt)}',
                        style: const TextStyle(
