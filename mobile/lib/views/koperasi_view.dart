...
class KoperasiView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final mainProposal = provider.activeProposals.isNotEmpty
        ? provider.activeProposals[0]
        : null;
    ...
    final kasPct =
        totalAset > 0 ? (provider.asetKas / totalAset * 100).round() : 0;
    final pinjamanPct =
        totalAset > 0 ? (provider.asetPinjaman / totalAset * 100).round() : 0;
    final investasiPct =
        totalAset > 0 ? (provider.asetInvestasi / totalAset * 100).round() : 0;
            ...
            children: [
              Container(
                ...
                child: const Column(
                  ...
                  children: [
                    Text('Dashboard Koperasi',
                        style: TextStyle(
                            color: Colors.white,
                            fontSize: 26,
                            fontWeight: FontWeight.bold)),
                    Text('Koperasi Merah Putih Desa Sukamaju',
                          ...
                          children: [
                            ...
                            GridView.count(
                              ...
                              children: [
                                ...
                                _buildWhiteStatCard(
                                    'Total Transaksi',
                                    '${provider.kopTransaksi}',
                                    'Simpanan & Pinjaman'),
                                _buildWhiteStatCard(
                                    'Total Aset Desa',
                                    fmtNum(provider.totalAsetDesa),
                                    'Konsolidasi'),
                                _buildWhiteStatCard(
                                    'UMKM Aktif',
                                    provider.kopUmkm > 0
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildAsetBar(
                                'Kas & Likuiditas',
                                kasPct,
                                fmtNum(provider.asetKas),
                                const Color(0xFF3B82F6)),
                            const SizedBox(height: 12),
                            _buildAsetBar(
                                'Pinjaman Anggota',
                                pinjamanPct,
                                fmtNum(provider.asetPinjaman),
                                const Color(0xFFF59E0B)),
                            const SizedBox(height: 12),
                            _buildAsetBar(
                                'Investasi & Lainnya',
                                investasiPct,
                                fmtNum(provider.asetInvestasi),
  ...
  void _showVoteConfirmation(
      BuildContext context, String choice, String proposalTitle) {
      ...
      builder: (BuildContext ctx) {
        return AlertDialog(
          ...
          content: Text(
            ...
            style: const TextStyle(
                color: Color(0xFF475569), fontSize: 14, height: 1.4),
          ),
          actionsPadding:
        ...
        ElevatedButton(
          onPressed: _busy
              ...
              : () async {
                  ...
                  setState(() => _busy = true);
                  final msg = await provider.submitProposal(
