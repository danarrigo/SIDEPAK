...
class ProfileView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final initials = provider.fullName != null && provider.fullName!.isNotEmpty
        ...
        : 'AG';
    final rankGradient =
        _rankColors[provider.rankName] ?? _rankColors['Perunggu']!;
                  ...
                  children: [
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onLongPress: () =>
                                  _showBenefitSheet(context, provider.rankName),
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        'RANK ${provider.rankName.toUpperCase()}',
                                        style: const TextStyle(
                                            color: Colors.white,
                                            fontSize: 10,
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        _buildTopBadge(Icons.workspace_premium,
                            '${provider.xp} XP', Colors.white, Colors.white12,
                ...
                child: Column(
                  ...
                  children: [
                              ...
                              child: Row(
                                children: [
                                  _buildRankItem(
                                      ...
                                      'Perunggu',
                                      Colors.greenAccent,
                                      provider.rankName == 'Perunggu'),
                                  _buildRankDivider(),
                                  _buildRankItem(
                                      Icons.military_tech,
                                      'Perak',
                                      Colors.amberAccent,
                                      provider.rankName == 'Perak'),
                                  _buildRankDivider(),
                                  _buildRankItem(
                                      Icons.workspace_premium,
                                      'Emas',
                                      const Color(0xFFF59E0B),
                                      provider.rankName == 'Emas'),
                                  _buildRankDivider(),
                                  _buildRankItem(
                                      Icons.diamond,
                                      'Platinum',
                                      Colors.lightBlue,
                                      provider.rankName == 'Platinum',
                                      opacity:
                                          provider.level >= 30 ? 1.0 : 0.5),
                                  _buildRankDivider(),
                                  _buildRankItem(
                                      Icons.grade,
                                      'Legenda',
                                      Colors.redAccent,
                                      provider.rankName == 'Legenda',
                                      opacity:
                                          provider.level >= 40 ? 1.0 : 0.5),
                                ],
                              ),
                            ),
                            const SizedBox(height: 16),
                    ...
                    GridView.count(
                      ...
                      children: [
                        _buildImpactCard('Total Simpanan',
                            'Rp ${(totalSimpananDisplay / 1000000).toStringAsFixed(1)}Jt'),
                        _buildImpactCard('Misi Diselesaikan',
                            '${provider.missions.where((m) => m.isCompleted).length}'),
                        _buildImpactCard(
                            'Level Kamu', 'Level ${provider.level}'),
                        _buildImpactCard(
                            'Tingkat Kemenangan', '${provider.userWinRate}%'),
                      ],
                    ),
                    const SizedBox(height: 16),
                    ...
                    const Text('Riwayat Aktivitas Poin',
                        style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                            color: Color(0xFF475569))),
                        ...
                        child: provider.pointTransactions.isEmpty
                            ...
                            : ListView.separated(
                                ...
                                separatorBuilder: (_, __) => const Divider(
                                    color: Color(0xFFF1F5F9), height: 8),
                    ...
                    const Text('Mutasi & Ledger Keuangan',
                        style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                            color: Color(0xFF475569))),
                    ...
                    Card(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.stretch,
                          children: [
                            if (provider.listSavings.isEmpty &&
                                provider.listLoans.isEmpty &&
                                provider.listWalletTxs.isEmpty)
                              const Padding(
                                padding: EdgeInsets.symmetric(vertical: 20),
                              ...
                              if (provider.listSavings.isNotEmpty) ...[
                                ...
                                ...provider.listSavings.map((s) {
                                  ...
                                  final int amount =
                                      (s['amount'] as num?)?.toInt() ?? 0;
                                  final String desc =
                                      s['description'] ?? 'Transaksi Simpanan';
                                  return Padding(
                                    padding:
                              ...
                              if (provider.listWalletTxs.isNotEmpty) ...[
                                if (provider.listSavings.isNotEmpty ||
                                    provider.listLoans.isNotEmpty) ...[
                                  const Divider(height: 1),
                                  const SizedBox(height: 12),
                                ],
                                const Text('Top Up & Transaksi Dompet',
                                    style: TextStyle(
                                        fontSize: 12,
                                        fontWeight: FontWeight.bold,
                                        color: Color(0xFF475569))),
                                ...
                                ...provider.listWalletTxs.map((w) {
                                  final int amount =
                                      (w['amount'] as num?)?.toInt() ?? 0;
                                  final String status =
                                      w['status'] ?? 'pending';
                                  final String date = w['createdAt'] != null
                                      ? w['createdAt'].toString().split('T')[0]
                                      : '';
                                      ...
                                      children: [
                                        Column(
                                          crossAxisAlignment:
                                              CrossAxisAlignment.start,
                                          children: [
                                            const Text('Top Up Saldo Dompet',
                                                style: TextStyle(
                                                    fontSize: 12,
                                                    fontWeight: FontWeight.bold,
                                                    color: Color(0xFF1E293B))),
                        ...
                        child: provider.inventory.isEmpty
                            ? const Column(
                                children: [
                                  ...
                                  SizedBox(height: 8),
                                  Text('Inventori kosong.',
                                      style: TextStyle(
                                          color: Colors.grey, fontSize: 12)),
                                  SizedBox(height: 4),
                                  Text('Beli item di Toko Misi!',
                                      style: TextStyle(
                    ...
                    SizedBox(
                      ...
                      child: provider.earnedBadges.isEmpty
                          ? const Center(
                              child: Text('Belum ada penghargaan',
                                  style: TextStyle(
                                      color: Colors.grey, fontSize: 12)),
                            )
                          : ListView.separated(
  ...
  Widget _buildTopBadge(IconData icon, String text, Color textCol, Color bgCol,
      {Color? iconColor}) {
    return Container(
      decoration: BoxDecoration(
        color: bgCol,
        borderRadius: BorderRadius.circular(20),
        border:
            bgCol == Colors.white12 ? Border.all(color: Colors.white10) : null,
      ),
      ...
      child: Row(
        ...
        children: [
          ...
          Text(text,
              style: TextStyle(
                  color: textCol, fontSize: 9, fontWeight: FontWeight.bold)),
        ],
      ),
    );
  }
  ...
  Widget _buildRankItem(IconData icon, String title, Color color, bool isActive,
      {double opacity = 1.0}) {
    return Opacity(
      opacity: opacity,
      child: Column(
        children: [
          Container(
            ...
            child: Icon(icon,
                color: isActive ? const Color(0xFFFBBF24) : color,
                size: isActive ? 28 : 22),
          ),
          const SizedBox(height: 6),
          Text(
  ...
  Widget _buildAchievementIcon(String title, String desc, IconData icon,
      {double opacity = 1.0}) {
    return Opacity(
      opacity: opacity,
      child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    if (invoiceUrl == null) ...[
                      ...
                      const SizedBox(height: 12),
                      const Text('Invoice Pembayaran Dibuat',
                          style: TextStyle(
                              color: Colors.white,
                              fontWeight: FontWeight.bold,
                              fontSize: 14)),
                      const SizedBox(height: 6),
                      const Text('Invoice Xendit telah dibuka di tab baru.',
                          style:
                      ...
                      if (verificationStatus == 'paid') ...[
                        ...
                        ElevatedButton(
                          ...
                          child: const Text('Buka Kembali Pembayaran',
                              style: TextStyle(
                                  color: Colors.white,
                                  fontWeight: FontWeight.bold)),
                        ),
                        ...
                        ElevatedButton(
                          onPressed: isLoading
                              ...
                              : () async {
                                  ...
                                  final res =
                                      await provider.verifyTopUp(invoiceId!);
                                  setState(() {
                                    isLoading = false;
                                  });
                                  if (res['success'] == true) {
