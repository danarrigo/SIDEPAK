            ...
            {tab === "events" &&
              events.map((ev) => (
                <tr key={ev.id} className="hover:bg-slate-50">
                  ...
                  <td className="px-6 py-4">
                    <span
                      className={`px-2 py-1 rounded-md text-[10px] font-bold ${ev.status === "pending_approval" ? "bg-amber-100 text-amber-700" : ev.status === "active" ? "bg-emerald-100 text-emerald-700" : "bg-slate-100 text-slate-600"}`}
                    >
            ...
            {tab === "proposals" &&
              proposals.map((prop) => (
                <tr key={prop.id} className="hover:bg-slate-50">
                  ...
                  <td className="px-6 py-4">
                    <span
                      className={`px-2 py-1 rounded-md text-[10px] font-bold ${prop.status === "pending_approval" ? "bg-amber-100 text-amber-700" : prop.status === "active" ? "bg-emerald-100 text-emerald-700" : "bg-slate-100 text-slate-600"}`}
                    >
