...
import 'admin_governance_view.dart';
...
class _AdminNavigationWrapperState extends State<AdminNavigationWrapper> {
  ...
  Widget _buildBody() {
    switch (_currentIndex) {
      ...
      case 2:
        return const AdminGovernanceView();
      case 3:
        ...
        child: SafeArea(
          child: Row(
            ...
            children: [
              ...
              _buildNavItem(2, Icons.how_to_vote_rounded, 'Tata Kelola'),
              _buildNavItem(3, Icons.monitor_heart_rounded, 'Kesehatan'),
